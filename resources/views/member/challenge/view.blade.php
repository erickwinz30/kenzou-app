...
<div class="pagetitle d-flex justify-content-between align-items-center">
  ...
  <a href="{{ route('homepage') }}" type="button" class="btn btn-primary"
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2">
          <div>
            <h2 class="fs-5 fw-bold">Tipe hadiah yang diperoleh</h2>
            <p>{{ $progress->challenge->reward_type }}</p>
          </div>
          <div>
            <h2 class="fs-5 fw-bold">Jumlah hadiah yang diperoleh</h2>
            <p>{{ $progress->challenge->reward_value }}</p>
          </div>
        </div>
        <div>
