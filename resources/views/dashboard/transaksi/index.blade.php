              ...
              <tbody id="transaksiTableBody">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @else
                    <span
                      style="color:red; background-color: maroon; border-radius: 5px; padding: 5px 10px; display: inline-block;">
                      Belum Konfirmasi
                    </span>
                    @endif
                  </td>
                  ...
                  <td>
                    ...
                    <form action="/dashboard/transaksi/{{ $transaksi->id }}" method="POST" class="d-inline"
                      ...
                      @method('DELETE')
                      @csrf
                      <button type="button" class="btn btn-danger" onclick="deleteConfirmation('{{ $transaksi->id }}')">
