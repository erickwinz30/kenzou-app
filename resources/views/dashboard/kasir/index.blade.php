                ...
                <div class="modal-body">
                  <form action="" method="POST" id="edit-form">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="edit_username" name="username" required autofocus>
                      @error('edit_username')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <div class="mb-3">
                      <label for="edit_email" class="form-label @error('edit_email') is-invalid @enderror">Email</label>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-warning" id="edit-button" data-bs-toggle='modal' data-bs-target='#editModal'
                      data-id="{{ $user->id }}" data-nama="{{ $user->nama }}" data-username="{{ $user->username }}"
                      data-email="{{ $user->email }}" data-nomor_telepon="{{ $user->nomor_telepon }}"
                      data-is_admin="{{ $user->is_admin }}"><i class="bi bi-pencil"></i></button>
                    <form action="/dashboard/kasir/{{ $user->id }}" method="POST" class="d-inline"
                      id="deleteForm{{ $user->id }}">
                      @method('DELETE')
                      @csrf
                      <button type="button" class="btn btn-danger" onclick="deleteConfirmation('{{ $user->id }}')">
