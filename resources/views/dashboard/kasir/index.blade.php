...
@section('container')
                    ...
                    <form action="/dashboard/kasir" method="POST">
                      ...
                      <div class="mb-3">
                        <label for="nomor_telepon" class="form-label @error('nomor_telepon') is-invalid @enderror">No.
                          Hp</label>
                        <input type="text" class="form-control" id="input-nomor_telepon" name="nomor_telepon"
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" id="is-admin-select-input" name="is_admin">
                  ...
                  <div class="modal-body">
                    <form action="" method="POST" id="edit-form">
                      ...
                      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                        <div class="mb-3">
                          <label class="form-label">Peran</label>
                          <select class="form-select" id="is-admin-select" name="is_admin">
                            <option value="0">Kasir</option>
                            <option value="1">Admin</option>
                          </select>
                        </div>
                        <div class="mb-3">
                          ...
                          <select class="form-select" id="is-active-select" name="is_active">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="d-flex">
                          <input type="password" class="form-control" id="edit-password" name="password" autofocus>
                          <button type="button" class="btn btn-outline-secondary" style="margin-left: 6px;"
                ...
                <tbody>
                  @foreach ($users as $user)
                    <tr>
                      ...
                      <td>
                        <form action="/dashboard/kasir/active-switch" method="POST"
                          id="toggleActivationForm{{ $user->id }}">
                          @csrf
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      editButtons.forEach(button => {
        button.addEventListener('click', function() {
          ...
          let nomorTelepon = button.getAttribute('data-nomor_telepon');
          let isAdmin = button.getAttribute('data-is_admin');
          ...
          const isAdminSelect = document.getElementById('is-admin-select').querySelectorAll('option');
          isAdminSelect.forEach((option) => {
            console.log(option.value);
            console.log(isAdmin);
            if (option.value == isAdmin) {
              option.selected = true;
            }
          });

          const isActiveSelect = document.getElementById('is-active-select').querySelectorAll('option');
          isActiveSelect.forEach((option) => {
            console.log(option.value);
    ...
    function toggleActivation(id) {
      Swal.fire({
        title: "Yakin ingin mengubah status aktivasi kasir?",
        text: "Aksi ini akan mengubah status aktivasi kasir!!!",
        icon: "warning",
