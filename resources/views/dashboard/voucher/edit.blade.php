              ...
              <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama"
                    value="{{ old('nama', $voucher->nama) }}" required autofocus>
                  @error('nama')
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="3" required autofocus>{{ old('description', $voucher->description) }}</textarea>
                  @error('description')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" inputmode="numeric"
                      ...
                      value={{ round(old('minimum_transaction', $voucher->minimum_transaction)) }} required autofocus>
                  </div>
