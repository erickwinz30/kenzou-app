            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="d-flex justify-content-end">
                ...
                <a href="/dashboard/allVoucherFetch" class="btn btn-primary"
                  style="background-color: #4154f1; color:white" id="allVoucherButton">Semua</a>
              </div>
            </div>
                  ...
                  @foreach ($vouchers as $voucher)
                    <tr>
                      ...
                      <td>
                        ...
                        <form action="/dashboard/toggle-voucher-activation" method="POST"
                          id="toggleForm{{ $voucher->id }}">
                          @csrf
                          <button type="button" class="btn btn-secondary"
                            onclick="toggleConfirmation({{ $voucher->id }})">
          ...
          .then((data) => {
            ...
            data.forEach(voucher => {
              ...
              row.innerHTML = `
                ...
                <td>${voucher.point_needed}</td>
                <td>${voucher.discount * 100}%</td>
                <td>Rp ${voucher.minimum_transaction}</td>
                <td class="text-center align-middle" style="padding: 0;">
                  <span
                    style="color:#FFB22C; background-color: #F3FEB8; border-radius: 5px; padding: 5px 10px; display: inline-block;">
                    Tidak Aktif
                ...
                <td>
                  ...
                  <form action="/dashboard/toggle-voucher-activation" method="POST" id="toggleForm${voucher.id}">
                    @csrf
                    <button type="button" class="btn btn-secondary" onclick="toggleConfirmation('${voucher.id}')">
